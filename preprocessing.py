"""
preprocessing.py — raw UCI CSV → ML-ready credit_card_data.csv

Input:  UCI_Credit_Card.csv  (original UCI Taiwan dataset, 30,000 rows × 25 cols)
Output: credit_card_data.csv (~29,965 rows after deduplication)

Runs all data hygiene, feature engineering, column selection, log-transforms,
and one-hot encoding so model.py and benchmark.py can load and train without
